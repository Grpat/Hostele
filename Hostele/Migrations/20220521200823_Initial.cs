    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hostele", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NazwaRodzaju = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CenaZaNocleg = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pokoje_Hostele_HostelId",
                        column: x => x.HostelId,
                        principalTable: "Hostele",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Pokoje_Rodzaje_RodzajId",
                        column: x => x.RodzajId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wypozyczenia_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pokoje_RodzajId",
                table: "Pokoje",
                column: "RodzajId");

            migrationBuilder.CreateIndex(
                name: "IX_Wypozyczenia_AppUserId",
                table: "Wypozyczenia",
                column: "AppUserId");
