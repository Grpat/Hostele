...
namespace Hostele.Migrations
{
    ...
    [Migration("20220521200823_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hostele.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Hostele.Models.Hostel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hostele.Models.Pokoj", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hostele.Models.Rodzaj", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NazwaRodzaju")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Hostele.Models.Wypozyczenie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hostele.Models.Wypozyczenie", b =>
                {
                    ...
                    b.HasOne("Hostele.Models.Pokoj", "Pokoj")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Hostele.Models.AppUser", null)
                        .WithMany()
